...
assert.ok(html.includes("import-passenger-field--${fieldClass}"), "bundle deve gerar classes visuais por campo de passageiro importado");
assert.ok(html.includes(".import-passenger-field--centro-custo"), "bundle deve conter largura curta para CR importado");
assert.ok(html.includes("dataset.importPassengerInput = field"), "bundle deve identificar campo de passageiro importado");
