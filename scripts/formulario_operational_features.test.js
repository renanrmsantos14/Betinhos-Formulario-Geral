...
includes(app, "dataset.importPassengerInput = field", "campos de passageiro importado devem expor papel visual");
includes(app, "import-passenger-field--${fieldClass}", "passageiros importados devem usar classes por campo");
...
const importPassengerFieldsRule = extractCssRule(css, ".import-passenger-fields {");
includes(importPassengerFieldsRule, "display: flex;", "lista de campos do passageiro importado deve seguir layout flex do design system");
includes(importPassengerFieldsRule, "flex-wrap: wrap;", "campos do passageiro importado devem ser compactos e responsivos");
const importPassengerNameFieldRule = extractCssRule(css, ".import-passenger-field--nome {");
includes(importPassengerNameFieldRule, "220px", "nome do passageiro importado deve ter largura principal");
const importPassengerCrFieldRule = extractCssRule(css, ".import-passenger-field--centro-custo {");
includes(importPassengerCrFieldRule, "92px", "CR importado deve ser campo curto");
