...
includes(importTrechoCardFunction, "buildImportTextarea(\"Observação operacional\", \"observacaoOperacional\", trecho.observacaoOperacional, { obs: true })", "observacao deve usar mesmo campo operacional do formulario comum");
