...
includes(importTrechoCardFunction, "buildImportTextarea(\"Observação\", \"observacaoOperacional\", trecho.observacaoOperacional)", "observacao deve ficar solta junto aos demais campos");
